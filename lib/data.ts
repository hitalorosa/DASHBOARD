...
export const disparosMaio: Disparo[] = [
  empty('1',  '2025-05-05', 'Oferta 05/05',           'sazonal',        'Base Toda'),
  empty('2',  '2025-05-06', 'Ressaca 05/05',           'ressaca',        'Nao Compraram 05/05'),
  empty('3',  '2025-05-08', 'Esquenta Mes das Maes',   'esquenta',       'Base Toda'),
  empty('4',  '2025-05-09', 'Esquenta Mes das Maes',   'esquenta',       'Carrinho Abandonado 60d'),
  empty('5',  '2025-05-10', 'Dia das Maes',            'sazonal',        'Base Toda'),
  empty('6',  '2025-05-11', 'Ressaca Dia das Maes',    'ressaca',        'Nao Compraram Dia das Maes'),
  empty('7',  '2025-05-13', 'LP Tonalizantes',         'produto',        'Base Toda'),
  empty('8',  '2025-05-15', 'Disparo da Madrugada',    'comportamental', 'Clientes Noturnos'),
  empty('9',  '2025-05-18', 'Oferta Necessaire',       'brinde',         'Base Toda'),
  empty('10', '2025-05-20', 'Quarta Relampago',        'sazonal',        'Base Toda'),
  empty('11', '2025-05-22', 'Disparo Base Popup',      'comportamental', 'Vieram do Popup'),
  empty('12', '2025-05-24', 'LP Tonalizantes',         'produto',        'Carrinho Abandonado Camuflage'),
  empty('13', '2025-05-26', 'Body Splash',             'brinde',         'Nunca Compraram'),
  empty('14', '2025-05-29', 'Oferta Fim de Mes',       'fimmes',         'Base Toda'),
  empty('15', '2025-05-30', 'Oferta Fim de Mes',       'fimmes',         'Nao Compraram 29/05'),
  empty('16', '2025-05-31', 'Oferta Fim de Mes',       'fimmes',         'Carrinho Abandonado Geral'),
];
...
export const datasazonais2025: DataSazonal[] = [
  ...
  { data: '2025-05-11', evento: 'Dia das Maes',          categoria: 'diad',      relevancia: 'alta' },
